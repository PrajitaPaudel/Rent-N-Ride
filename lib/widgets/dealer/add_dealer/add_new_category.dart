...
class DAddCategory extends StatefulWidget {
  const DAddCategory({super.key});

  @override
  State<DAddCategory> createState() => _AddCategoryState();
}

class _AddCategoryState extends State<DAddCategory> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          THeaderAppBar(text: "Add Category",),
          Column(
              children: [
                BigText(
