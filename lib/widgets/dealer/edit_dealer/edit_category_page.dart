...
class DEditCategory extends StatefulWidget {
  final VehicleCategoryModel? category;
final int? categoryId;
  const DEditCategory({super.key, this.categoryId, this.category,});

  @override
  State<DEditCategory> createState() => _EditCategoryState();
}

class _EditCategoryState extends State<DEditCategory> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          const THeaderAppBar(text: "Edit Category",),
          Column(
              children: [
                BigText(
