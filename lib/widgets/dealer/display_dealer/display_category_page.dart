...
import '../add_dealer/add_new_category.dart';
import '../edit_dealer/edit_category_page.dart';

class DealerDisplayCategory extends StatelessWidget {
  DealerDisplayCategory({super.key});
                  ...
                  itemBuilder: (_, index) {
                    ...
                    return Padding(
                      ...
                      child: THCard(
                        ...
                        edit: () {
                         Get.to(()=>DEditCategory(categoryId: category.categoryId,));
                        },
                        delete: (){
