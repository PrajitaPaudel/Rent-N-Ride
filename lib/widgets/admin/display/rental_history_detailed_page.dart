...
class RentalHistoryDetailedPage extends StatelessWidget {
  final Values values;
  final defaultImageUrl = "assets/logos/logo-white.png";
   const RentalHistoryDetailedPage({super.key, required this.values});
                ...
                children: [
                  TCircularContainer(
                    ...
                    child: TRoundedImages(
                      ...
                      imageUrl: values.vehicleImageUrl??defaultImageUrl,
